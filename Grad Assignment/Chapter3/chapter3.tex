...
\par RQ1: How do  Continual Learning approaches compare with offline learning for classification of glitches?\\%Do the results of classes learned from a continual learning approach align with existing gravity spy classes?\\
